        ...
        children: [
          SingleChildScrollView(
            ...
            child: Row(
              ...
              children: days.map((day) => _buildDayTile(day)).toList(),
            ),
          ),
    ...
    return Container(
      decoration: BoxDecoration(
        color: selectedDay == day
            ? Colors.deepPurple
            : const Color.fromARGB(255, 238, 238, 240),
        borderRadius: BorderRadius.circular(9),
      ),
      ...
      child: InkWell(
        onTap: () {
          ...
          // Clear filtercardData before adding new matching cards
          fitercardData.clear();

          for (Map<String, String> card in cardData) {
            if (selectedDay == card['day']) {
              fitercardData.add(card);
            } else {
              print("no");
            }
          }
